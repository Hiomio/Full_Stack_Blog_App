    ...
    <div className="settings">
      <div className="settingsWrapper">
        ...
        <form className="settingsForm" onSubmit={handleSubmit}>
          ...
          {file ? (
          <img src={URL.createObjectURL(file)} alt="Profile" className="abc" />
              ) : user.profilePic ? (
           <img src={user.profilePic} alt="Profile" className="abc" />
          ) : (
             <FaUserCircle size={80} className="profileIcon" /> // Show icon when no profile picture
            )}
          </div>
